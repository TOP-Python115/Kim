...
def count_time(func):
    def wrapper():
        ...
        print(f"Elapsed time: {start} ns, {stop} ns")
        print(f"Elapsed time during whole program: {stop-start} ns")
...
def person_info():
    ...
    l = [(u['name'], u['email']) for u in data if not u['phone']]
    
# Elapsed time: 114281251469600 ns, 114281251495100 ns
# Elapsed time during whole program: 25500 ns
# >>>
